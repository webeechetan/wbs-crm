  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="googleMeetingModalLabel">Schedule Google Meeting</h5>
      ...
      <div class="modal-body">
        <form id="googleMeetingForm" method="POST" action="{{ route('google.oauth') }}">
          @csrf
          <input type="text" name="inquiry_id" id="inquiryId" value="">
          <input type="text" name="attendees" id="attendeesInput">
          <div class="row mb-3">
            <div class="col-md-6">
